...
const TopNav = ({ selectedFolder, folderName, setSelectedFolder }: TProps) => {
    ...
    return (
        <div className='flex items-center gap-1'>
            ...
            {selectedFolder && (
                <button className='flex capitalize items-center px-3 text-sm py-1.5 gap-1.5 font-semibold cursor-pointer bg-primary text-white rounded-full hover:bg-text/10 hover:text-text duration-300'>
