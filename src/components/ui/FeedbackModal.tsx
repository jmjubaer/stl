...
const FeedbackModal = () => {
  ...
  const [entries, setEntries] = useState<TFeedbackEntry[]>([{ ...defaultEntry }]);
  ...
  const handleSendFeedback: SubmitHandler<TInputs> = (data) => {
    ...
    //   });
    //   if (res?.success) {
    //     ShowAlert('Thank You!', 'success', 'Your feedback has been sent successfully.');
    //     handleCancel();
    //   } else {
    //     ShowAlert('Error', 'error', res?.message || 'Failed to send feedback');
    //   }
    // });
  };
            ...
            <div className='border border-text/20 rounded-2xl p-4 mb-4'>
              ...
              <div className='mb-3'>
                ...
                <input
                  ...
                  className={`border w-full px-4 py-2 rounded-xl outline-0 text-sm ${
                    errors.name ? 'border-red-500' : 'border-text/30'
                  }`}
                />
                {errors.name && (
              ...
              <div>
                ...
                <input
                  ...
                  className={`border w-full px-4 py-2 rounded-xl outline-0 text-sm ${
                    errors.email ? 'border-red-500' : 'border-text/30'
                  }`}
                />
                {errors.email && (
                  <span className='text-red-500 text-xs mt-1 block'>
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      value={entry.message}
                      onChange={(e) =>
                        handleEntryChange(index, 'message', e.target.value)
                      }
                      rows={3}
